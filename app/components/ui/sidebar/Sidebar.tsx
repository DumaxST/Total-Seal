...
export const Sidebar = () => {
  return (
   <div id="menu" className="bg-white min-h-screen z-10 text-slate-300 w-64  left-0 h-screen">
            <div id="logo" className="my-4 px-6">
              <h1 className="text-lg md:text-2xl font-bold text-blue-500 uppercase">Menú</h1>
            </div>
            ...
            <div id="nav" className="w-full px-6">
              ...
              <a href="#" className="w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/5 transition ease-linear duration-150">
                  ...
                  <div className="flex flex-col">
                      <span className="text-lg text-slate-300 font-bold leading-5">Unidades</span>
                  </div>
              </a>
